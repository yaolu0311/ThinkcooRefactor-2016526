...
import com.yz.im.ui.widget.ChatRowLongClickView;
...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private ChatRowLongClickView.ChatRowLongClickViewDelegate mDelegate;
    ...
    private void setUpBaseView() {
        ...
        if (message.direct() == Direct.SEND) {
            UserInfoResponse response = IMHelper.getInstance().getInfoResponse();
            Glide.with(context).load(response.getHeadPortrait()).transform(new GlideRoundTransform(context, 10))
                    .placeholder(R.drawable.default_avatar).error(R.drawable.default_avatar).into(userAvatarView);
        } else {
...
//                    bubbleLayout.setBackgroundDrawable(context.getResources().getDrawable(R.drawable.ease_chatfrom_bg));
    ...
    private void initDialogView() {
        ...
        mDelegate = new ChatRowLongClickView.ChatRowLongClickViewDelegate(context, mList);
        mDelegate.setClickListener(new ChatRowLongClickView.OnItemClickListener() {
            @Override
    ...
    protected void onItemClick(String content, int position) {
        itemClickListener.onDialogItemClick(message, content, position);
        mDelegate.dismiss();
    }
    ...
    protected abstract List<String> initListItems();
