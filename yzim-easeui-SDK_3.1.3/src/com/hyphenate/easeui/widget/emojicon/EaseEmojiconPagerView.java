...
public class EaseEmojiconPagerView extends ViewPager{
    ...
    private List<EaseEmojiIcon> totalEmojiconList = new ArrayList<EaseEmojiIcon>();
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList, int emijiconColumns, int bigEmojiconColumns){
        ...
        for(int i = 0; i < groupEntities.size(); i++){
            ...
            List<EaseEmojiIcon> groupEmojicons = group.getEmojiconList();
    ...
    public List<View> getGroupGridViews(EaseEmojiconGroupEntity groupEntity){
        List<EaseEmojiIcon> emojiconList = groupEntity.getEmojiconList();
        ...
        for(int i = 0; i < pageSize; i++){
            ...
            List<EaseEmojiIcon> list = new ArrayList<EaseEmojiIcon>();
            if(i != pageSize -1){
            ...
            if(emojiType != Type.BIG_EXPRESSION){
                EaseEmojiIcon deleteIcon = new EaseEmojiIcon();
            ...
            gv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    EaseEmojiIcon emojicon = gridAdapter.getItem(position);
                    if(pagerViewListener != null){
    ...
    public interface EaseEmojiconPagerViewListener{
    	...
    	void onExpressionClicked(EaseEmojiIcon emojicon);
