...
public class EaseChatInputMenu extends LinearLayout {
    ...
    protected void processChatMenu() {
        ...
        emojiconMenu.setEmojiconMenuListener(new EaseEmojiconMenuListener() {
            ...
            @Override
            public void onExpressionClicked(EaseEmojiIcon emojicon) {
                if(emojicon.getType() != EaseEmojiIcon.Type.BIG_EXPRESSION){
    ...
    public interface ChatInputMenuListener {
         ...
         * @param emojicon
         */
        void onBigExpressionClicked(EaseEmojiIcon emojicon);
