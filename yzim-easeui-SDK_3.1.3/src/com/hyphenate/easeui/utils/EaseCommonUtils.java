...
//              digest = EasyUtils.getAppResourceString(context, "location_prefix");
            ...
            /*if(((DemoHXSDKHelper)HXSDKHelper.getInstance()).isRobotMenuMessage(message)){
                ...
                } else if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_USR_CARD, false)) {
                    digest = getString(context, R.string.user_card_msg);
                } else if(isSystemMessage(message)){
                    digest = getString(context, R.string.system_notice);
                }else {
                    digest = txtBody.getMessage();
                }
                break;
