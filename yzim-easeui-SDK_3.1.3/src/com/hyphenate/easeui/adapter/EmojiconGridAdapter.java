...
public class EmojiconGridAdapter extends ArrayAdapter<EaseEmojiIcon>{

    private Type emojiconType;


    public EmojiconGridAdapter(Context context, int textViewResourceId, List<EaseEmojiIcon> objects, EaseEmojiIcon.Type emojiconType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EaseEmojiIcon emojicon = getItem(position);
