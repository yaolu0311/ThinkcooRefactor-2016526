...
public class PreferenceManager {
	...
	private static String SHARED_KEY_SETTING_CHAT_ROOM_OWNER_LEAVE = "shared_key_setting_chat_room_owner_leave";
	...
	private static String HAS_NEW_NOTIFICATION_MESSAGE = "has_new_notification_message";
	...
	public void setNewNotification(boolean paramBoolean) {
		editor.putBoolean(HAS_NEW_NOTIFICATION_MESSAGE, paramBoolean);
		editor.commit();
	}

	public boolean getNewNotification() {
		return mSharedPreferences.getBoolean(HAS_NEW_NOTIFICATION_MESSAGE, false);
	}
