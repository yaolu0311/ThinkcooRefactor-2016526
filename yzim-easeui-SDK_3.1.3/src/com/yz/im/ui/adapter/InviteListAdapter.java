 ...
 */
public class InviteListAdapter extends BaseContactListAdapter<Friend>{
     ...
     * @param isGroupMember
     */
    public InviteListAdapter(Context context, List<Friend> list, int checkBoxType, boolean isGroupMember) {
