...
public class VideoCallActivity extends CallActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().addFlags(
                WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON | WindowManager.LayoutParams
            ...
            public void onCallStateChanged(CallState callState, final CallError error) {
                switch (callState) {
                    ...
                    case ACCEPTED: // call is accepted
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                openSpeakerOn();
                                ((TextView) findViewById(R.id.tv_is_p2p)).setText(EMClient
                                        .getInstance().callManager().isDirectCall()
                    ...
                    case VIDEO_PAUSE:
                        runOnUiThread(new Runnable() {
                            public void run() {
                                ToastUtil.getInstance(VideoCallActivity.this).showToast
                                        ("VIDEO_PAUSE");
                            }
                        });
                        break;
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String s1 = getResources().getString(R.string
                                        .The_other_party_refused_to_accept);
                                String s2 = getResources().getString(R.string.Connection_failure);
                                String s3 = getResources().getString(R.string
                                        .The_other_party_is_not_online);
                                String s4 = getResources().getString(R.string
                                        .The_other_is_on_the_phone_please);
                                String s5 = getResources().getString(R.string
                                        .The_other_party_did_not_answer);
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_refuse_call) {
            ...
            if (!isRecording) {
                ...
                ToastUtil.getInstance(VideoCallActivity.this).showToastById(R.string
                        .record_finish_toast);
            }
        ...
        new Thread(new Runnable() {
            public void run() {
                while (monitor) {
                    runOnUiThread(new Runnable() {
                        public void run() {
                            monitorTextView.setText("WidthxHeight：" + callHelper.getVideoWidth()
