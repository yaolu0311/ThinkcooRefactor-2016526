 ...
 */
public class UserSkillCase extends UseCase<Object> {

    UserRepository mUserRepository;

    @Inject
    public UserSkillCase(@Named(ApplicationModule.UI_THREAD_NAMED) Scheduler mUiThread,
    ...
    protected Observable buildUseCaseObservable(Object...q) {
        return mUserRepository.getUserSkill();
    }
}
