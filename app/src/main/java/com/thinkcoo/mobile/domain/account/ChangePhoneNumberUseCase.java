...
/**
 * Created by Leevin
 * CreateTime: 2016/8/8  11:11
 */
public class ChangePhoneNumberUseCase extends UseCase<Object> {

    AccountRepository mAccountRepository;

    @Inject
    public ChangePhoneNumberUseCase(@Named(ApplicationModule.UI_THREAD_NAMED) Scheduler mUiThread,
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mAccountRepository.changeAccountName((Account) q[0], (Vcode)q[1],(String)q[2]);
    }
}
