 ...
 */
public class LoadTrainCourseDetailCase extends UseCase<Object>{
    // TODO: 2016/7/27
    @Inject
    protected LoadTrainCourseDetailCase(@Named(ApplicationModule.UI_THREAD_NAMED) Scheduler mUiThread,
