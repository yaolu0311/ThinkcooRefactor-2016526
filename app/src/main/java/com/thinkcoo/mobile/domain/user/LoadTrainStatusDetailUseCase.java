 ...
 */
public class LoadTrainStatusDetailUseCase extends UseCase<Object>{

    UserStatusRepository mUserRepository;

    @Inject
    public LoadTrainStatusDetailUseCase(
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mUserRepository.loadUserTrainStatusDetail((UserStatus) q[0]);
    }
}
