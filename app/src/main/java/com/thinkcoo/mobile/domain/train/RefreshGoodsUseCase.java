 ...
 */
public class RefreshGoodsUseCase extends UseCase<Object>{

    TradeRepository mTradeRepository;

    public RefreshGoodsUseCase(Scheduler mUiThread, Scheduler mExecutorThread, TradeRepository tradeRepository) {
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mTradeRepository.refreshMyGoods((MyGoods) q[0]);
    }
}
