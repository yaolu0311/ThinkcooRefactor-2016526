 ...
 */
public class LoadFullTimeStatusDetailUseCase extends UseCase<Object>{

    UserStatusRepository mUserRepository;

    @Inject
    public LoadFullTimeStatusDetailUseCase(
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mUserRepository.loadUserFullTimeWorkStatusDetail((UserStatus) q[0]);
    }
}
