 ...
 */
public class ChangeUserSingatureUseCase extends UseCase<Object> {
    UserRepository mUserRepository;

    @Inject
    protected ChangeUserSingatureUseCase(
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mUserRepository.changeChangeUserSignature((String) q[0]);
    }
}
