 ...
 */
public class LoadPartTimeStatusDetailUseCase extends UseCase<Object>{

    UserStatusRepository mUserRepository;

    @Inject
    public LoadPartTimeStatusDetailUseCase(
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mUserRepository.loadUserPartTimeWorkStatusDetail((UserStatus) q[0]);
    }
}
