 ...
 */
public class DeleteUserSkillCase extends UseCase<Object> {

    UserRepository mUserRepository;

    @Inject
    public DeleteUserSkillCase(@Named(ApplicationModule.UI_THREAD_NAMED) Scheduler mUiThread,
    ...
    protected Observable buildUseCaseObservable(Object...q) {
        return mUserRepository.deleteUserSkill((String)q[0]);
    }
}
