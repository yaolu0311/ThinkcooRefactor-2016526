 ...
 */
public class SerchStudentsCase extends UseCase<Object> {
    ScheduleRepository mScheduleRepository;

    @Inject
    public SerchStudentsCase(
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        ...
        return mScheduleRepository.serchStudents(selectStudentParam.getEventId(),selectStudentParam.getSchool(),selectStudentParam.getClassProfession(),selectStudentParam.getKeyWord(),selectStudentParam.getPageMachine());
    }
}