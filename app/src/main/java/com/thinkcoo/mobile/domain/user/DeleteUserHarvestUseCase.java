...
/**
 * Created by Leevin
 * CreateTime: 2016/6/1  13:17
 */
public class DeleteUserHarvestUseCase extends UseCase<String>{

    UserRepository mUserRepository;

    @Inject
    public DeleteUserHarvestUseCase(
    ...
    protected Observable buildUseCaseObservable(String... q) {
        return mUserRepository.deleteUserHarvest(q[0]);
    }
}
