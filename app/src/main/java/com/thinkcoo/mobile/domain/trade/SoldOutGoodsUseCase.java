 ...
 */
public class SoldOutGoodsUseCase extends UseCase<Object>{

    TradeRepository mTradeRepository;

    public SoldOutGoodsUseCase(Scheduler mUiThread, Scheduler mExecutorThread, TradeRepository tradeRepository) {
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mTradeRepository.soldOutMyGoods((MyGoods)q[0]);
    }
}
