 ...
 */
public class AddTrainCollectionOrAppointmentUseCase extends UseCase<Object>{
    // TODO: 2016/7/27
    @Inject
    protected AddTrainCollectionOrAppointmentUseCase(@Named(ApplicationModule.UI_THREAD_NAMED) Scheduler mUiThread,
