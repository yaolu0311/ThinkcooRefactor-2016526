 ...
 */
public class DeleteMyGoodsUseCase extends UseCase<Object>{

    TradeRepository mTradeRepository;

    public DeleteMyGoodsUseCase(Scheduler mUiThread, Scheduler mExecutorThread, TradeRepository tradeRepository) {
    ...
    protected Observable buildUseCaseObservable(Object... q) {
        return mTradeRepository.deleteMyGoods((MyGoods)q[0]);
    }
