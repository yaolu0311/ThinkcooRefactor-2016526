 ...
 */
public class EditUserHobbyCase extends UseCase<Object> {

    UserRepository mUserRepository;
    @Inject
    public EditUserHobbyCase(@Named(ApplicationModule.UI_THREAD_NAMED) Scheduler mUiThread,
    ...
    protected Observable buildUseCaseObservable(Object...q) {
        return mUserRepository.addUserHobby((String)q[0]);
    }
