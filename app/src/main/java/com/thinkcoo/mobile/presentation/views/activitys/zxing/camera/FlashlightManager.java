...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      ThinkcooLog.d(TAG, "This device does supports control of a flashlight");
    } else {
      ThinkcooLog.d(TAG, "This device does not support control of a flashlight");
    }
  }
  ...
  private static Class<?> maybeForName(String name) {
    try {
      ...
      ThinkcooLog.d(TAG, "Unexpected error while finding class " +re);
      return null;
    }
  }
  ...
  private static Method maybeGetMethod(Class<?> clazz, String name, Class<?>... argClasses) {
    try {
      ...
      ThinkcooLog.d(TAG, "Unexpected error while finding method " +re);
      return null;
    }
  }
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      ...
      ThinkcooLog.d(TAG, "Unexpected error while invoking " + e);
      return null;
    } catch (InvocationTargetException e) {
      ThinkcooLog.d(TAG, "Unexpected error while invoking " +e.getCause());
      return null;
    } catch (RuntimeException re) {
      ThinkcooLog.d(TAG, "Unexpected error while invoking " + re);
      return null;
    }
  }
