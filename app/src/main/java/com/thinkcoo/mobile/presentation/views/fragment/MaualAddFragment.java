...
import com.thinkcoo.mobile.presentation.mvp.presenters.MaualAddStudentPresenter;
 ...
 */
public class MaualAddFragment extends BaseLcePagedFragment<Student> implements MaualAddStudentView<Student> {

    @Inject
    MaualAddStudentPresenter mMaualAddStudentPresenter;
    ...
    protected BaseLcePagedPresenter provideBaseLcePagedPresenter() {
        return mMaualAddStudentPresenter;
    }
...
//        holder.headPortrait.setImageURI(Uri.parse(student.getHeadPortrait()));
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        getHostActivity().mManualAddPresenter.addMerberToGroup( getHostActivity().getEvent().scheduleId, getHostActivity().mGroupId, student.getAccountId());
//                        mOnItemClickListener.onItemClick(student);
    ...
    public String getContent() {
        return getHostActivity().getContent();
    }

    private ManualAddActivity getHostActivity() {
        return (ManualAddActivity) getActivity();
    }
