 ...
 */
public class RockResultByUuidResponse {


    /**
     * list : [{"eventRosterId":"点名Id","headPortrait":"头像","studentName":"学生姓名","studentNo":"学号","groupName":"班组名称","checkDate":"签到时间","eventPlace":"事件地点","isRegister":"是否登记","status":"状态 0 未到 1已到"}]
     * totalCnt : 总人数
     * absenceCnt : 未到人数
     * normalCnt : 已到人数
     * registerCnt : 未注册（暂无）
    ...
    public static class ListBean {
        ...
        public boolean hasheadPortrait(){
            return !TextUtils.isEmpty(headPortrait);
        }
    }
}
