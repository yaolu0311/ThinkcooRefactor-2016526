...
import com.thinkcoo.mobile.model.entity.nullentities.NullFullTimeJobDetial;
import com.thinkcoo.mobile.model.entity.nullentities.Nullable;

/**
 * Created by Robert.yao on 2016/5/30.
 */
public class FullTimeJobDetail extends UserStatusDetail implements Nullable, Parcelable {

    public static  final FullTimeJobDetail NULL_FULL_TIME_JOB_DETAIL = new NullFullTimeJobDetial();
    ...
    public FullTimeJobDetail() {
    }

    protected FullTimeJobDetail(Parcel in) {
    ...
    public static final Parcelable.Creator<FullTimeJobDetail> CREATOR = new Parcelable.Creator<FullTimeJobDetail>() {
        @Override
        public FullTimeJobDetail createFromParcel(Parcel source) {
            return new FullTimeJobDetail(source);
        }

        @Override
        public FullTimeJobDetail[] newArray(int size) {
            return new FullTimeJobDetail[size];
        }
    };
    ...
    public boolean equals(Object o) {
        ...
        FullTimeJobDetail that = (FullTimeJobDetail) o;
